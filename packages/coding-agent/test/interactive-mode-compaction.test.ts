...
describe("InteractiveMode compaction events", () => {
	test("rebuilds chat after compaction without adding a duplicate summary banner", async () => {
		const fakeThis = {
			isInitialized: true,
		...
		// rebuildChatFromMessages() -> renderSessionContext() already renders the
		// compaction summary from buildSessionContext(); adding it again here
		// caused the banner to appear twice on every compaction.
